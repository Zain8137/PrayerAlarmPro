...
source.include_exts = py,kv,png,jpg,mp3,json,ttf
...
android.permissions = android.permission.INTERNET,android.permission.WAKE_LOCK,android.permission.RECEIVE_BOOT_COMPLETED,android.permission.VIBRATE
